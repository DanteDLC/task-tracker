...
const LoginForm = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center">
        <button
          className="flex w-full items-center justify-center gap-2 rounded-md bg-[#1e3a8a] px-4 py-2 text-xs font-medium text-white transition duration-200 hover:cursor-pointer hover:bg-[#152a62] disabled:bg-gray-300 sm:text-base"
